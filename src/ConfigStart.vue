<template>
  ...
  <button @click="handleStartGame" class="mb-2 p-4 text-lg bg-blue-900 text-white font-medium rounded-md w-full shadow-xs hover:bg-blue-800 focus:outline-hidden focus:ring-2 focus:ring-blue-300">
    Start Game
  </button>
</template>
